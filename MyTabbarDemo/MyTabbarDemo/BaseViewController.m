...
//    automaticallyAdjustsScrollViewInsets 为YES 时，
//    
...
-(void)showLeft:(UIButton *)sender
{
    ...
    NSLog(@"SubOne-->%@",NSStringFromClass(self.tabBarController.class));
    
//    if ([NSStringFromClass(self.tabBarController.class) isEqualToString:@"ViewController"]) {
